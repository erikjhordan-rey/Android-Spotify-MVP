...
public class TracksActivity extends AppCompatActivity implements TracksMvpView, AppBarLayout.OnOffsetChangedListener {
    ...
    @Bind(R.id.toolbar)
    Toolbar toolbar;
    @Bind(R.id.appbar_artist)
    AppBarLayout appbar_artist;
    @Bind(R.id.iv_collapsing_artist)
    ImageView iv_collapsing_artist;
    @Bind(R.id.civ_artist)
    CircleImageView civ_artist;
    @Bind(R.id.txt_title_artist)
    TextView txt_title_artist;
    @Bind(R.id.txt_title_tracks)
    TextView txt_title_tracks;
    @Bind(R.id.txt_followers_artist)
    TextView txt_followers_artist;
    @Bind(R.id.txt_subtitle_artist)
    TextView txt_subtitle_artist;
    @Bind(R.id.rv_tracks)
    RecyclerView rv_tracks;
    @Bind(R.id.pv_tracks)
    ProgressBar pv_tracks;
    @Bind(R.id.iv_tracks)
    ImageView iv_tracks;
    @Bind(R.id.txt_line_tracks)
