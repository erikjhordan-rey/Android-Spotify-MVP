...
import static gdg.androidtitlan.spotifymvp.example.data.api.Constants.Serialized.FOLLOWERS;
import static gdg.androidtitlan.spotifymvp.example.data.api.Constants.Serialized.HREF;
import static gdg.androidtitlan.spotifymvp.example.data.api.Constants.Serialized.ID;
...
import static gdg.androidtitlan.spotifymvp.example.data.api.Constants.Serialized.POPULARITY;
